    ...
    @if (patient(); as p) {
      <div class="sum">
        ...
        <mat-card class="sum__card">
          <mat-card-header>
            <mat-card-title class="sum__card-title"><mat-icon>person</mat-icon>Demographics</mat-card-title>
          </mat-card-header>
          <mat-card-content>
            <div class="sum__grid">
        ...
        <mat-card class="sum__card">
          <mat-card-header>
            <mat-card-title class="sum__card-title"><mat-icon>contacts</mat-icon>Contact</mat-card-title>
          </mat-card-header>
          <mat-card-content>
            <div class="sum__grid">
              <div class="sum__field">
        ...
        @if (p.emergencyContacts.length) {
          <mat-card class="sum__card">
            <mat-card-header>
              <mat-card-title class="sum__card-title"><mat-icon>emergency</mat-icon>Emergency Contacts</mat-card-title>
            </mat-card-header>
            <mat-card-content>
        ...
        @if (p.insurancePolicies.length) {
          <mat-card class="sum__card">
            <mat-card-header>
              <mat-card-title class="sum__card-title"><mat-icon>health_and_safety</mat-icon>Insurance</mat-card-title>
            </mat-card-header>
            <mat-card-content>
        ...
        @if (store.selectedActiveAlerts().length) {
          <mat-card class="sum__card sum__card--alerts">
            <mat-card-header>
              <mat-card-title class="sum__card-title sum__card-title--alert"><mat-icon>notification_important</mat-icon>Active Alerts</mat-card-title>
            </mat-card-header>
            <mat-card-content>
        ...
        <mat-card class="sum__card">
          <mat-card-header>
            <mat-card-title class="sum__card-title"><mat-icon>gavel</mat-icon>Consent &amp; Privacy</mat-card-title>
          </mat-card-header>
          <mat-card-content>
            <div class="sum__grid">
              <div class="sum__field">
